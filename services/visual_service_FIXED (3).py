"""
Visual Service - OLD SDK + GEMINI 3.0 PRO
Uses: import google.generativeai as genai
Model: gemini-3-pro-preview (NOT 2.0 flash!)
"""
...
class VisualService:
    ...
    def __init__(self, api_key: str):
        ...
        logger.info(f"✅ VisualService ready with OLD SDK: {self.model_names}")
                                ...
                                if hasattr(candidate.content, 'parts') and candidate.content.parts:
                                    if len(candidate.content.parts) > 0:
                                        ...
                                        if hasattr(part, 'text'):
                                            logger.info(f"✅ Vision success (fallback): {model_name}")
                                            return part.text
                except Exception:
                    pass
