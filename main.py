...
CRITICAL: Static file mounts MUST be at the END after all route definitions!
"""
...
# ═══════════════════════════════════════════════════════════════════
# API ENDPOINTS - Define these BEFORE static file mounts!
# ═══════════════════════════════════════════════════════════════════
...
# Mount in this order: specific paths first, catch-all last
# ═══════════════════════════════════════════════════════════════════

# Mount /data folder for felix_questions.json
app.mount("/data", StaticFiles(directory="data"), name="data")

# Mount frontend last (catch-all for everything else)
