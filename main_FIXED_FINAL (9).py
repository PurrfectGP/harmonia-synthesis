...
async def generate_response(request: ResponseGeneratorRequest):
    ...
    try:
        ...
        # Use what WORKED: gemini-2.0-flash-exp with JSON mode!
        ...
        print(f"🤖 Using gemini-2.0-flash-exp with JSON mode")
...
NOW GENERATE RESPONSE (50-80 words, vague, deep, nuanced):"""
        ...
        for idx, (model_name, model_label) in enumerate(models_to_try, 1):
            try:
                ...
                print(f"   Sending request with NEW SDK...")
                ...
                # NEW SDK - response.text should work properly!
